...
HD_PWD='C:/Users/Frank/OneDrive/Escritorio/TRABAJO/MAQ_EXPENDEDORA/MAQ_EXPENDEDORA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MAQ_EXPENDEDORA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MAQ_EXPENDEDORA.tcl -notrace

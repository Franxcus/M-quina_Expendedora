...
HD_PWD='C:/Users/Frank/OneDrive/Escritorio/TRABAJO/MAQ_EXPENDEDORA/MAQ_EXPENDEDORA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MAQ_EXPENDEDORA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MAQ_EXPENDEDORA.tcl
